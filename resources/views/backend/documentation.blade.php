...
<body>
    ...
    <div id="documenter_content">
        ...
        <section id="addon">
            ...
            <h2><strong>Madina Super Shop WooCommerce</strong></h2>
            <p>Imagine you have an existing WooCommerce website. Now you want to use Madina Super Shop and also want to synchronize your WooCommerce website with Madina Super Shop. If you want to do so then this is the ultimate solution you are looking for. Madina Super Shop WooCommerce addon comes with complete synchronization with your WooCommerce website. You can synchronize your orders from WooCommerce to Madina Super Shop. Also you can can synchronize products, categories from Madina Super Shop to WooCommerce. And you have to map your Madina Super Shop taxes with WooCommerce taxes.</p>
            ...
            <p>If you go to the WooCommerce section you will get all the necessary options to sync your Wocommerce categories, products, taxes and orders. You can also sync products from Madina Super Shop to WooCommerce from the product create or edit page.</p>
            <p>
