...
<section>
    ...
    <div class="table-responsive">
        <table id="department-table" class="table">
            ...
            <tbody>
                <tr>
                    <td>Madina Super Shop SaaS</td>
                    <td>It's a standalone application to start subscription business with Madina Super Shop. It is a multi tenant system and each client will have their separate database. This application comes with free landing page, unlimited custom pages, blog, payment gateway and lots more.</td>
                    <td>
                        <div class="btn-group">
                            <a target="_blank" href="https://lion-coders.com/software/Madina Super Shop-saas-pos-inventory-saas-php-script" class="btn btn-primary btn-sm" title="Madina Super Shop SaaS"><i class="dripicons-basket"></i> Buy Now</a>&nbsp;
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>Madina Super Shop WooCommerce</td>
                    <td>An addon to integrate Madina Super Shop with your existing WooCommerce website.</td>
                    <td>
                        <div class="btn-group">
                            @if (!\Schema::hasColumn('products', 'woocommerce_product_id'))
                            <a target="_blank" href="https://lion-coders.com/software/salepro-saas-pos-inventory-saas-php-script" class="btn btn-primary btn-sm" title="Madina Super Shop SaaS"><i class="dripicons-basket"></i> Buy Now</a>&nbsp;&nbsp;
